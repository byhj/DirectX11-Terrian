...
void RenderSystem::init_device()
{
	...
	hr = m_pD3D11Device->CreateRasterizerState(&rasterDesc, &m_pRasterStateNoCulling);
	...
	hr = m_pD3D11Device->CreateBlendState(&blendStateDesc, &m_pDisableBlendState);
...
void RenderSystem::DisableBlend()
{
	...
	m_pD3D11DeviceContext->OMSetBlendState(m_pDisableBlendState, blendFactor, 0xffffffff);
}
...
void RenderSystem::EnableCulling()
{
	m_pD3D11DeviceContext->RSSetState(m_pRasterState);
}
void RenderSystem::DisableCulling()
{
	m_pD3D11DeviceContext->RSSetState(m_pRasterStateNoCulling);
}
