...
namespace byhj
{
	...
	void RenderSystem::init_device()
	{
		...
		hr = m_pD3D11Device->CreateBlendState(&blendStateDesc, &m_pBlendDisableState);
	...
	void RenderSystem::DisableBlend()
	{
		...
		m_pD3D11DeviceContext->OMSetBlendState(m_pBlendDisableState, blendFactor, 0xffffffff);
	}
