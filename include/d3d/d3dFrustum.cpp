...
D3DFrustum::D3DFrustum()
{
}


D3DFrustum::D3DFrustum(const D3DFrustum& other)
{
}
...
void D3DFrustum::ConstructFrustum(float screenDepth, D3DXMATRIX projectionMatrix, D3DXMATRIX viewMatrix)
{
	float zMinimum, r;
	D3DXMATRIX matrix;
